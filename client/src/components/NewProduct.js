...
import { useNavigate } from 'react-router-dom' // this was useHistory in a previous version of react-router-dom
...
function NewProduct() {
  const navigate = useNavigate()  // this was useHistory() in a previous version of react-router-dom
